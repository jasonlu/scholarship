...
class SiteConfigsControllerTest < ActionController::TestCase
  ...
  test "should create site_config" do
    assert_difference('SiteConfig.count') do
      post :create, site_config: { copyright: @site_config.copyright, description: @site_config.description, keywords: @site_config.keywords, sitename: @site_config.sitename }
    end
  ...
  test "should update site_config" do
    put :update, id: @site_config, site_config: { copyright: @site_config.copyright, description: @site_config.description, keywords: @site_config.keywords, sitename: @site_config.sitename }
    assert_redirected_to site_config_path(assigns(:site_config))
  end
