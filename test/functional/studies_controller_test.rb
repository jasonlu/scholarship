...
class StudiesControllerTest < ActionController::TestCase
  ...
  test "should create study" do
    assert_difference('Study.count') do
      post :create, study: { course_id: @study.course_id, progress_id: @study.progress_id, status: @study.status, user_id: @study.user_id }
    end
  ...
  test "should update study" do
    put :update, id: @study, study: { course_id: @study.course_id, progress_id: @study.progress_id, status: @study.status, user_id: @study.user_id }
    assert_redirected_to study_path(assigns(:study))
  end
